...
var EntityModel = require("chthonios/game/entities/Entity");
var PlayerModel = require("chthonios/game/player/NetworkPlayer");

var Nodegraph = require("chthonios/game/math/NodeGraph");

/**
 * @class World
 */
var World = Environment.Class.extend(
/** @lends World.prototype */
{
	uid : null,
	players : [],
	entities : [],
	...
	init : function(uid, width, height, chunkWidth, chunkHeight) {
		Common.assert(uid !== undefined && uid !== null, "cannot generate world without uid");
		this.uid = uid;
		this.width = width;
		this.height = height;
		...
		for (var i = 0; i < this.entities.length; i++) {
			...
			if (entity !== null) {
				try {
					...
					console.warn(player.toString(), "problem sending entity data", e);
				}
			}
		}
...
var Chunk = Environment.Class.extend({
	tiles : null,
	nodemap : null,
	width : 0,
	height : 0,
...
var WorldGenerator = Environment.Class.extend({
	seed : null,
